...
@test mightbemissing(@implemented(gen(::DBNTuple{(:sp,:o,:r)}, ::B, ::Int, ::Bool, ::MersenneTwister)))
...
@test @inferred gen(DBNTuple(:sp,:r), B(), 1, false, Random.GLOBAL_RNG) == (1, -1.0)

@test @implemented gen(::DBNVar{:o}, b::B, s::Int, a::Bool, sp::Int, rng::AbstractRNG)
@test mightbemissing(@implemented(gen(::DBNTuple{(:sp,:o)}, b::B, s::Int, a::Bool, rng::MersenneTwister)))
@test mightbemissing(@implemented gen(::DBNTuple{(:sp,:o,:r)}, b::B, s::Int, a::Bool, rng::MersenneTwister))
@test @inferred gen(DBNTuple(:sp,:o,:r), B(), 1, true, Random.GLOBAL_RNG) == (2, 2, -1.0)
...
@test mightbemissing(@implemented gen(::DBNTuple{(:sp,:o,:r)}, ::C, ::Nothing, ::Nothing, ::MersenneTwister))
@test @inferred gen(DBNTuple(:sp,:o,:r), C(), nothing, nothing, Random.GLOBAL_RNG) == (nothing, nothing, 0.0)
...
@test_throws MethodError gen(DBNTuple(:sp,:r), GE(), 1, 1, Random.GLOBAL_RNG)
POMDPs.gen(::GE, s, a, ::AbstractRNG) = (sp=s+a, r=s^2)
@test @inferred gen(DBNVar(:sp), GE(), 1, 1, Random.GLOBAL_RNG) == 2
@test @inferred gen(DBNTuple(:sp,:r), GE(), 1, 1, Random.GLOBAL_RNG) == (2, 1)
