...
@test_throws DistributionNotImplemented @gen(:o)(W(), 1, true, Random.GLOBAL_RNG)
try
...
@test_throws DistributionNotImplemented @gen(:sp,:o,:r)(B(), 1, false, Random.GLOBAL_RNG)
...
@test_throws DistributionNotImplemented @gen(:sp)(GE(), 1, 1, Random.GLOBAL_RNG)
@test_throws DistributionNotImplemented @gen(:sp,:r)(GE(), 1, 1, Random.GLOBAL_RNG)
