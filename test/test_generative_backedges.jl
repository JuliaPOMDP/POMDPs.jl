...
let
    ...
    @test_throws DistributionNotImplemented @gen(:sp)(M(), 1, 1, MersenneTwister(4))
    POMDPs.transition(::M, ::Int, ::Int) = [1]
    @test @gen(:sp)(M(), 1, 1, MersenneTwister(4)) == 1
    @test_throws DistributionNotImplemented @gen(:sp,:o,:r)(M(), 1, 1, MersenneTwister(4))
    @test_throws DistributionNotImplemented @gen(:sp,:r)(M(), 1, 1, MersenneTwister(4))
